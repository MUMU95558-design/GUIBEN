    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-sky-50">
      ...
      <div className="bg-white/80 backdrop-blur-xl border-b border-slate-200/60 px-6 py-4 shadow-sm">
        <div className="max-w-4xl mx-auto flex items-center justify-between">
          ...
          <a href="/chat" className="flex items-center gap-2 text-slate-600 hover:text-sky-600 text-sm transition-colors font-medium">
            <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
      ...
      <div className="px-6 py-8">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="text-center mb-12 animate-fade-in">
            <div className="inline-flex items-center justify-center w-16 h-16 bg-gradient-to-br from-sky-100 to-blue-100 rounded-2xl mb-6 shadow-lg">
